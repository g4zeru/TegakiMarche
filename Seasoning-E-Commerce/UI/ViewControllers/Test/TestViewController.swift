...
extension TestViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "itemcompactlist", for: indexPath) as! ItemCompactListCell
        //cell.update(title: "ヨシダ グルメのたれ オリジナル 645g", buttonTitle: "レビュー", image: UIImage(named: "Item6")!)
        cell.update(title: "ヨシダ グルメのたれ オリジナル 645g", price: 1000, image: UIImage(named: "Item6")!)
        return cell
    }
}
